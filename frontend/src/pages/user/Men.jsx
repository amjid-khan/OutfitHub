            ...
            <div className="text-left w-full space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-blue-100/90 text-lg font-light leading-relaxed max-w-lg">
                  Experience the pinnacle of men's fashion with our exclusive
            ...
            <div className="w-full relative">
              <div className="relative">
                <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-white/20 bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-lg">
                  <img
                    src="https://images.unsplash.com/photo-1617137968427-85924c800a22?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80"
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-4 border border-white/20 shadow-2xl">
                      <div className="flex justify-between items-start mb-3">
                        <div>
                          <h3 className="text-white font-bold text-xl mb-1">Signature Tailored Blazer</h3>
                          <p className="text-blue-200/90 text-sm">Premium Italian Wool Blend</p>
                        </div>
                        <div className="text-right">
                          <div className="text-white font-bold text-xl">$299</div>
                          <div className="text-blue-300/80 text-sm line-through">$399</div>
                        </div>
                      </div>
                    </div>
                  </div>
